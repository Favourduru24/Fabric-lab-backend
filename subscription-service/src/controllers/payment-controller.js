...
const createOrder = async (req, res) => {
    ...
    try {
           ...
           data: {
            intent: 'CAPTURE',
             purchase_units: [
                ...
                description: 'Fabric-lab Premium Membership'
                }
            ],
            application_context: {
        ...
        const approvedLink = order.links.find(link => link.rel === 'approve').href
       ...
       console.log('Error while creating paypal order', error)
    }
}
...
const capturePayment = async (req, res) => {
    ...
    const response = await axios({
       ...
       console.log('Error while capturing paypal order', error)
    }
}
